...
export default function UploaderSettingsPage() {
  const { user, loading: authLoading } = useShortsContext();
  ...
  const inputClass = "w-full px-3.5 py-2.5 rounded-xl bg-[#fafafa] border border-[#e5e5e5] text-sm text-[#0a0a0a] outline-none focus:border-[#F44444] focus:ring-1 focus:ring-[#F44444]/20 transition-all";
    ...
    <div className="p-6 lg:p-8 max-w-[1200px]">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          <input type="text" value={title} onChange={e => setTitle(e.target.value)} placeholder="e.g. Video Creator" className={inputClass} />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="Tell viewers about your channel and shorts"
            rows={4}
