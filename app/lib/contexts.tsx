...
}>({ isSignedIn: false, userRole: null, currentUserId: 0, canPost: false, userProfile: null, isAuthInitialized: false, unreadNotifCount: 0, signOut: () => { }, signIn: () => { }, openAuthModal: () => { }, updateUserProfile: () => { }, setIsAuthInitialized: () => { } });
