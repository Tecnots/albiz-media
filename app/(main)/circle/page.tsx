...
function CircleProfileRow({ member, showRank = true }: { member: any; showRank?: boolean }) {
  ...
  return (
    <Link href={`/${member.handle}?_customDomain=1`} className="flex items-center gap-3 p-3 rounded-xl hover:bg-[#fafafa] transition-colors group w-full text-left">
      ...
      <span className="px-3 py-1.5 text-xs font-medium rounded-full border border-[#e5e5e5] text-[#525252] hover:bg-[#f5f5f5] flex-shrink-0 transition-colors">View</span>
      <button
