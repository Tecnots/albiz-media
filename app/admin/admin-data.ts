...
export const generateAdminNews = () => [
  { id: 1, title: "Albiz Connect launches Circle membership program", status: "published" as const, date: "Feb 25, 2026", views: "12.4k", image: "https://picsum.photos/seed/admin-news-1/400/200" },
  { id: 2, title: "New content moderation policies take effect", status: "published" as const, date: "Feb 22, 2026", views: "8.1k", image: "https://picsum.photos/seed/admin-news-2/400/200" },
  { id: 3, title: "Platform reaches 10,000 active users milestone", status: "published" as const, date: "Feb 18, 2026", views: "15.2k", image: "https://picsum.photos/seed/admin-news-3/400/200" },
  { id: 4, title: "Introducing advanced analytics for Circle members", status: "published" as const, date: "Feb 14, 2026", views: "6.8k", image: "https://picsum.photos/seed/admin-news-4/400/200" },
  { id: 5, title: "Community guidelines update for 2026", status: "draft" as const, date: "Feb 26, 2026", views: "0" },
  { id: 6, title: "Partnership announcement with leading tech companies", status: "draft" as const, date: "Feb 26, 2026", views: "0" },
];
...
export const generateEditorialQueue = () => [
  { id: 101, title: "How India's UPI is reshaping global payments", authorId: 2, authorName: "Arun Mehta", authorAvatar: "https://picsum.photos/seed/author-2/200", status: "submitted" as ArticleWorkflowStatus, submittedAt: "2h ago", wordCount: 1840, tags: ["Fintech", "India", "Payments"] },
  { id: 102, title: "The silent revolution in AI chip design", authorId: 4, authorName: "James O'Brien", authorAvatar: "https://picsum.photos/seed/author-4/200", status: "under_review" as ArticleWorkflowStatus, submittedAt: "5h ago", wordCount: 2200, tags: ["AI", "Hardware", "Technology"], reviewer: "Jessin Sam S" },
  { id: 103, title: "European regulators take aim at big tech", authorId: 3, authorName: "Emily Zhang", authorAvatar: "https://picsum.photos/seed/author-3/200", status: "approved" as ArticleWorkflowStatus, submittedAt: "1d ago", wordCount: 1560, tags: ["Policy", "Technology", "EU"] },
  { id: 104, title: "Startup funding winter: Is the worst over?", authorId: 1, authorName: "Sarah Mitchell", authorAvatar: "https://picsum.photos/seed/author-1/200", status: "revision_requested" as ArticleWorkflowStatus, submittedAt: "1d ago", wordCount: 2400, tags: ["Startups", "Finance"], revisionNote: "Needs updated Q4 data and a stronger conclusion." },
  { id: 105, title: "5G rollout faces new infrastructure hurdles", authorId: 1, authorName: "Sarah Mitchell", authorAvatar: "https://picsum.photos/seed/author-1/200", status: "draft" as ArticleWorkflowStatus, submittedAt: "2d ago", wordCount: 800, tags: ["Technology", "Telecom"] },
  { id: 106, title: "Climate tech investment hits record high", authorId: 3, authorName: "Emily Zhang", authorAvatar: "https://picsum.photos/seed/author-3/200", status: "published" as ArticleWorkflowStatus, submittedAt: "3d ago", wordCount: 1920, tags: ["Climate", "Finance", "Technology"] },
  { id: 107, title: "The rise of sovereign AI strategies", authorId: 4, authorName: "James O'Brien", authorAvatar: "https://picsum.photos/seed/author-4/200", status: "submitted" as ArticleWorkflowStatus, submittedAt: "4h ago", wordCount: 1680, tags: ["AI", "Policy", "Global"] },
];
