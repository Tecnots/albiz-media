...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorFirebaseAuthentication", path: "../../../node_modules/.pnpm/@capacitor-firebase+authentication@8.3.0_@capacitor+core@8.3.1_firebase@12.13.0/node_modules/@capacitor-firebase/authentication"),
        .package(name: "CapacitorFirebaseMessaging", path: "../../../node_modules/.pnpm/@capacitor-firebase+messaging@8.3.0_@capacitor+core@8.3.1_firebase@12.13.0/node_modules/@capacitor-firebase/messaging"),
        ...
        .package(name: "CapacitorToast", path: "../../../node_modules/.pnpm/@capacitor+toast@8.0.1_@capacitor+core@8.3.1/node_modules/@capacitor/toast")
    ],
    targets: [
        .target(
            name: "CapApp-SPM",
