...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorFirebaseAuthentication", path: "..\..\..\node_modules\.pnpm\@capacitor-firebase+authent_0e39aef0e3f264792ac405a5607314a3\node_modules\@capacitor-firebase\authentication"),
        .package(name: "CapacitorActionSheet", path: "..\..\..\node_modules\.pnpm\@capacitor+action-sheet@8.1.1_@capacitor+core@8.3.1\node_modules\@capacitor\action-sheet"),
        ...
        .package(name: "CapacitorToast", path: "..\..\..\node_modules\.pnpm\@capacitor+toast@8.0.1_@capacitor+core@8.3.1\node_modules\@capacitor\toast")
    ],
    targets: [
        .target(
            name: "CapApp-SPM",
