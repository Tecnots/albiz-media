...
async function main() {
  ...
  await prisma.notification.createMany({
    data: [
      { id: 1, type: "FOLLOW", userId: 3, time: "2min ago", group: "TODAY", unread: true },
      { id: 2, type: "FOLLOW", userId: 7, time: "7min ago", group: "TODAY", unread: true },
      { id: 3, type: "LIKE", userId: 5, time: "2hr ago", group: "TODAY", unread: true, postPreview: "Happy to share that Example.com...", postImage: "https://picsum.photos/seed/funding-announce/200/200" },
      { id: 4, type: "COMMENT", userId: 4, time: "3hr ago", group: "TODAY", unread: false, postPreview: "The best time to start investing was yesterday..." },
      { id: 5, type: "MENTION", userId: 2, time: "5hr ago", group: "TODAY", unread: false, postPreview: "Check out what @jessinsam is building..." },
      { id: 6, type: "LIKE_STORY", userId: 6, time: "1d ago", group: "YESTERDAY", unread: false },
      { id: 7, type: "FOLLOW", userId: 8, time: "1d ago", group: "YESTERDAY", unread: false },
      { id: 8, type: "LIKE", userId: 3, time: "1d ago", group: "YESTERDAY", unread: false, postPreview: "Building in public has been one of the best decisions..." },
      { id: 9, type: "COMMENT", userId: 7, time: "2d ago", group: "EARLIER", unread: false, postPreview: "AI is going to redefine every industry..." },
      { id: 10, type: "FOLLOW", userId: 4, time: "2d ago", group: "EARLIER", unread: false },
      { id: 11, type: "LIKE", userId: 6, time: "3d ago", group: "EARLIER", unread: false, postPreview: "Applications for YC Winter 2026 batch are now open..." },
      { id: 12, type: "MENTION", userId: 8, time: "3d ago", group: "EARLIER", unread: false, postPreview: "Zepto becomes India's fastest unicorn..." },
      { id: 13, type: "FOLLOW", userId: 2, time: "4d ago", group: "EARLIER", unread: false },
      { id: 14, type: "LIKE_STORY", userId: 3, time: "5d ago", group: "EARLIER", unread: false },
      { id: 15, type: "LIKE", userId: 4, time: "5d ago", group: "EARLIER", unread: false, postPreview: "SpaceX Starship completes first successful orbital flight..." },
    ],
  });
